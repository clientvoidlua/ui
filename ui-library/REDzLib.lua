...
local redzlib = {
  ...
  Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/clientvoidlua/ui/refs/heads/main/ui-library/Icons.lua"))()
}
...
local ScreenGui: ScreenGui = Create("ScreenGui", HiddenGui, {
  Name = redzLibName or "redz library",
}, {
  Create("UIScale", {
    Scale = UIScale,
    Name = "Scale"
...
function redzlib:SetTheme(NewTheme, saveTheme)
  ...
  if saveTheme == true then SaveJson("redz library.json", redzlib.Save) end
...
function redzlib:MakeWindow(Configs)
  ...
  local WMiniText = Configs[2] or Configs.SubTitle or "by tlredz"
  ...
  ConnectSave(ControlSize1, function()
    if not Minimized then
      ...
      SaveJson("redz library.json", redzlib.Save)
    end
  end)
